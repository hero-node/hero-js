(function() {
  ...
  $.AnyPicker = $.AnyPicker || {
    ...
    extra: {
      ...
      sCSSTransform: $.CF.testProperties(
        'transform',
        [
          'WebkitTransform',
          'MozTransform',
      ...
      sCSSTransformStyle: $.CF.setPropertiesStyle('transform', [
        'WebkitTransform',
        'MozTransform',
        'OTransform',
        'msTransform',
      ...
      sCSSTransition: $.CF.testProperties(
        'transition',
        [
          'WebkitTransition',
          'MozTransition',
      ...
      bHasCSSAnimation: $.CF.testProperties(
        'animation',
        [
          'WebkitAnimation',
          'MozAnimation',
  ...
  function AnyPicker(element, options) {
    ...
    var sLang =
        options.lang !== undefined || options.lang !== null
          ? options.lang
          : $.CalenStyle.defaults.lang,
      io18n = $.extend(
        true,
        {},
        $.AnyPicker.defaults.i18n,
        options.i18n,
        $.AnyPicker.i18n[sLang]
      ),
    ...
    if ($.CF.isValid(options.headerTitle)) apo.tmp.headerTitleDefined = true;

    if ($.CF.compareStrings(apo.setting.theme, 'Android')) {
      if (!$.CF.isValid(options.rowHeight)) apo.setting.rowHeight = 50;

      if (!$.CF.isValid(options.visibleRows)) apo.setting.visibleRows = 3;
    } else if ($.CF.compareStrings(apo.setting.theme, 'iOS')) {
      if (!$.CF.isValid(options.rowHeight)) apo.setting.rowHeight = 36;

      if (!$.CF.isValid(options.visibleRows)) apo.setting.visibleRows = 5;
      ...
      if ($.AnyPicker.extra.bIsiPad) apo.tmp.bIsiPad = true;
      ...
      if ($.CF.isValid(options.setButton)) apo.tmp.bModified.set = true;
      if ($.CF.isValid(options.cancelButton)) apo.tmp.bModified.cancel = true;
      if ($.CF.isValid(options.nowButton)) apo.tmp.bModified.now = true;
      if ($.CF.isValid(options.clearButton)) apo.tmp.bModified.clear = true;
    }
    ...
    $.AnyPicker.extra.sStartEv = $.AnyPicker.extra.bHasPointer
      ? $.AnyPicker.extra.bHasIE10Pointer
        ? 'MSPointerDown'
        : 'pointerdown'
      : $.AnyPicker.extra.bIsTouchDevice
        ? 'touchstart'
        : 'mousedown touchstart';
    $.AnyPicker.extra.sMoveEv = $.AnyPicker.extra.bHasPointer
      ? $.AnyPicker.extra.bHasIE10Pointer
        ? 'MSPointerMove'
        : 'pointermove'
      : $.AnyPicker.extra.bIsTouchDevice
        ? 'touchmove'
        : 'mousemove touchmove';
    $.AnyPicker.extra.sEndEv = $.AnyPicker.extra.bHasPointer
      ? $.AnyPicker.extra.bHasIE10Pointer
        ? 'MSPointerUp'
        : 'pointerup'
      : $.AnyPicker.extra.bIsTouchDevice
        ? 'touchend'
        : 'mouseup touchend';
    $.AnyPicker.extra.sLeaveEv = $.AnyPicker.extra.bHasPointer
      ? $.AnyPicker.extra.bHasIE10Pointer
        ? 'MSPointerLeave'
        : 'pointerleave'
      : $.AnyPicker.extra.bIsTouchDevice
        ? null
        : 'mouseleave';
    $.AnyPicker.extra.sCancelEv = $.AnyPicker.extra.bHasPointer
      ? $.AnyPicker.extra.bHasIE10Pointer
        ? 'MSPointerCancel'
        : 'pointercancel'
      : null;
  ...
  AnyPicker.prototype = {
    ...
    init: function() {
      ...
      if ($.CF.isValid(apo.elem)) {
        apo.tmp.sElemTag = $(apo.elem)
          .prop('tagName')
          .toLowerCase();
        if (apo.tmp.sElemTag === 'input' || apo.tmp.sElemTag === 'paper-input')
      ...
      if ($.CF.isValid(apo.setting.inputElement)) {
        apo.tmp.sInputElemTag = $(apo.setting.inputElement)
          .prop('tagName')
          .toLowerCase();
        if (
          apo.tmp.sInputElemTag === 'input' ||
          apo.tmp.sInputElemTag === 'paper-input'
        )
      ...
      if (
        ...
        if (apo.tmp.oInputElemValid.bIsInput) {
          ...
          $oInput.on('blur.' + apo.setting.timestamp, function(e) {
            if ($.AnyPicker.tempDefaults.tabKey) apo.showOrHidePicker();
      ...
      if ($.CF.isValid(apo.setting.onInit)) apo.setting.onInit.call(apo);
    },
    ...
    _inputElementClicked: function(e) {
      ...
      if (
        ...
        if (apo.tmp.oInputElemValid.bIsInput) sElemValue = $oInput.val();
          ...
          if ($.CF.isValid(sDataVal)) sElemValue = sDataVal;
    ...
    showOrHidePicker: function(sElemValue) {
      ...
      if ($(apo.tmp.overlaySelector).length > 0) apo._hidePicker();
      else apo._showPicker();
    },
    ...
    _showPicker: function() {
      ...
      var sTemp = '',
        bAddSectionHeader =
          ($.CF.compareStrings(apo.setting.layout, 'popup') ||
            $.CF.compareStrings(apo.setting.layout, 'popover')) &&
        ...
        bAddSectionFooterFixedTop =
          $.CF.compareStrings(apo.setting.layout, 'fixed') &&
          $.CF.compareStrings(apo.setting.vAlign, 'bottom') &&
          apo.setting.viewSections.footer.length > 0,
        bAddSectionFooterFixedBottom =
          $.CF.compareStrings(apo.setting.layout, 'fixed') &&
          $.CF.compareStrings(apo.setting.vAlign, 'top') &&
          apo.setting.viewSections.footer.length > 0,
        bIsDateTimeField =
          $.CF.compareStrings(apo.setting.mode, 'datetime') &&
      ...
      if ($.CF.compareStrings(apo.setting.layout, 'popover')) {
        var iBodyScrollTop = $('body').scrollTop(),
          ...
          iPopupHeight = $.CF.compareStrings(
          ...
          iTooltipBottom =
            $(apo.setting.inputElement).offset().top +
            $(apo.setting.inputElement).height() +
            iPopupHeight,
      ...
      sTemp +=
        "<div_anypicker class='ap-overlay " +
        sLayout +
        ' ' +
      ...
      sTemp += "<div_anypicker class='ap-bg'>";

      sTemp += "<div_anypicker class='ap-cont' dir='" + apo.tmp.sDir + "'>";
      ...
      if (bAddSectionHeader) {
        sTemp += "<div_anypicker class='ap-header'>";

        if (
          bIsDateTimeField &&
          $.CF.compareStrings(apo.setting.theme, 'Windows')
        ) {
          sTemp += "<div_anypicker class='ap-content-switch'>";
          if (apo.setting.rtl) {
            sTemp +=
      ...
      if (bAddSectionFooterFixedTop) {
        sTemp += "<div_anypicker class='ap-footer ap-footer-top'>";
        if ($.CF.compareStrings(apo.setting.theme, 'Default'))
          sTemp += "<div_anypicker class='ap-button-cont'></div_anypicker>";
        sTemp += '</div_anypicker>';
      }

      sTemp += "<div_anypicker class='ap-content'>";

      if (apo.setting.viewSections.contentTop.length > 0)
        sTemp += "<div_anypicker class='ap-content-top'></div_anypicker>";
      ...
      sTemp += "<div_anypicker class='ap-content-middle'>";

      sTemp += "<div_anypicker class='ap-component-section'></div_anypicker>";

      sTemp += '</div_anypicker>'; // Close .ap-content-middle

      if (apo.setting.viewSections.contentBottom.length > 0)
        sTemp += "<div_anypicker class='ap-content-bottom'></div_anypicker>";

      sTemp += '</div_anypicker>'; // Close .ap-content

      if (bAddSectionFooter || bAddSectionFooterFixedBottom) {
        sTemp += "<div_anypicker class='ap-footer ap-footer-bottom'>";
        if ($.CF.compareStrings(apo.setting.theme, 'Default'))
          sTemp += "<div_anypicker class='ap-button-cont'></div_anypicker>";
        sTemp += '</div_anypicker>';
      }

      sTemp += '</div_anypicker>'; // Close .ap-cont

      sTemp += '</div_anypicker>'; // Close .ap-bg

      sTemp += '</div_anypicker>'; // Close .ap-overlay

      $(apo.setting.parent).append(sTemp);

      if (apo.setting.layout === 'popover') $('body').addClass('noscroll');
    ...
    _hidePicker: function() {
      ...
      if ($(apo.tmp.overlaySelector).length > 0) {
        ...
        if (apo.setting.layout === 'popover') $('body').removeClass('noscroll');
    ...
    _adjustPicker: function(iNumOfComp) {
      ...
      if ($.CF.compareStrings(apo.setting.theme, 'Windows')) {
        iNumOfComp = $.CF.isValid(iNumOfComp)
          ? parseInt(iNumOfComp)
          : apo.tmp.numOfComp;
      ...
      if ($.CF.compareStrings(apo.setting.layout, 'popover')) {
        var iBodyScrollTop = $('body').scrollTop(),
          ...
          iPopupWidth = $(apo.tmp.overlaySelector)
            .find('.ap-cont')
            .outerWidth(),
          iPopupHeight = $(apo.tmp.overlaySelector)
            .find('.ap-cont')
            .outerHeight(),
          iPopupTop,
          iPopupLeft,
    ...
    _addViewSectionComponents: function() {
      ...
      for (
        iTempIndex1 = 0;
        iTempIndex1 < $.AnyPicker.extra.sArrViewSections.length;
        iTempIndex1++
      ) {
          ...
          for (
            ...
            if (oComp !== undefined && oComp !== null && oComp !== '') {
              if ($.CF.compareStrings(sViewSection, 'header')) {
                ...
                if (
                  $.CF.compareStrings(oComp.type, 'Button') &&
                  $.CF.compareDataType(oComp.action, 'function')
                )
                  $oCompElem.on(
                    'click.' + apo.setting.timestamp,
                    { apo: apo },
                ...
                var $oeButtonCont = $(apo.tmp.overlaySelector).find(
                  '.ap-button-cont'
                );
              ...
              if (
                $.CF.compareStrings(sComp, 'headerTitle') &&
                $.CF.compareStrings(oComp.contentBehaviour, 'Static')
              )
                $(apo.tmp.overlaySelector)
    ...
    _setDateTimeTabs: function(sSelectedTab) {
      ...
      var $oeDisabledTabs = $(apo.tmp.overlaySelector).find(
          "[data-type='" + sDisabledTab + "']"
        ),
        $oeSelectedTabs = $(apo.tmp.overlaySelector).find(
    ...
    _adjustOnOrientationChange: function() {
      ...
      if (sCurrentOrientation !== apo.tmp.sOrientation) {
        $('body').prepend(
          "<div_anypicker class='ap-loading'>Loading</div_anypicker>"
        );
  ...
  AnyPicker.prototype = $.extend(AnyPicker.prototype, {
    ...
    reloadAllComponents: function() {
      ...
      $(apo.setting.parent)
        .find('.ap-component-section')
        .html('');

      $('body').prepend("<div_anypicker class='ap-loading'></div_anypicker>");
    ...
    reloadComponent: function(iComp, bSingleLoad) {
      ...
      var iNumRows,
        ...
        sAlign = apo.setting.rtl
          ? $.CF.compareStrings(oComp.textAlign, 'left')
            ? 'right'
            : $.CF.compareStrings(oComp.textAlign, 'right')
              ? 'left'
              : ''
          : oComp.textAlign,
      ...
      if ($oeComp.length === 0)
        sTemp +=
          "<div_anypicker class='ap-component' id='" +
          sCompId +
          "' data-type='" +
          sType +
          "' " +
      ...
      if (!$.CF.compareStrings(apo.setting.theme, 'Windows')) {
        if (apo.setting.showComponentLabel)
          sTemp +=
            "<div_anypicker class='ap-component-label' " +
      ...
      if (
        $.CF.compareStrings(apo.setting.rowsNavigation, 'scroller+buttons') ||
        $.CF.compareStrings(apo.setting.rowsNavigation, 'buttons')
      )
        sTemp +=
          "<div_anypicker class='ap-component-plus ap-icon-arrow-up-filled' " +
          (sTextAlign !== '' ? "style='" + sTextAlign + ";'" : '') +
          '></div_anypicker>';

      sTemp += "<div_anypicker class='ap-component-cont' tabindex='0'>";

      sTemp +=
        "<div_anypicker class='ap-component-data' role='listbox' aria-label='" +
        oComp.label +
        "'>";

      for (iRowIndex = 0; iRowIndex < apo.tmp.iExt; iRowIndex++) {
        sTemp += "<div_anypicker class='ap-row ap-row-ext'></div_anypicker>";
      }

      for (iRowIndex = 0; iRowIndex < oSData.length; iRowIndex++) {
        bIsSelected = $.CF.isValid(oSData[iRowIndex].selected)
          ? oSData[iRowIndex].selected
          : false;
        sClassSelectedRow = bIsSelected ? 'ap-row-selected' : '';
        sTemp +=
          "<div_anypicker class='ap-row " +
          sClassSelectedRow +
          "' id='ap-row-" +
          iComp +
          '-' +
        ...
        if ($.CF.compareStrings(apo.setting.theme, 'Windows')) {
          sTemp += "<div_anypicker class='ap-row-bg'>";
          if (!$.CF.isValid(apo.setting.rowView))
            sTemp += "<div_anypicker class='ap-row-content'>";
        }
        ...
        if (
          $.CF.compareStrings(apo.setting.theme, 'Windows') &&
          !$.CF.isValid(apo.setting.rowView)
        ) {
          sTemp += '</div_anypicker>';
          sTemp += "<div_anypicker class='ap-row-label'>";
      ...
      sTemp += "<div_anypicker class='ap-component-gradient'></div_anypicker>";
      sTemp +=
        "<div_anypicker class='ap-component-selector' id='ap-component-selector-" +
        iComp +
        "'></div_anypicker>";
      ...
      if (
        ...
        sTemp +=
          "<div_anypicker class='ap-component-minus ap-icon-arrow-down-filled' " +
          (sTextAlign !== '' ? "style='" + sTextAlign + ";'" : '') +
          '></div_anypicker>';

      if ($oeComp.length === 0) sTemp += '</div_anypicker>';
    ...
    _bindEventsToComponent: function(iComp) {
      ...
      if (
        $.CF.compareStrings(apo.setting.rowsNavigation, 'scroller+buttons') ||
        $.CF.compareStrings(apo.setting.rowsNavigation, 'scroller')
      ) {
        $oCompCont.on(
          $.AnyPicker.extra.sStartEv + '.' + apo.setting.timestamp,
          oData,
          apo._onStartDrag
        );
        $oCompCont.on(
          $.AnyPicker.extra.sMoveEv + '.' + apo.setting.timestamp,
          oData,
          apo._onDrag
        );
        if ($.CF.isValid($.AnyPicker.extra.sEndEv))
          $oCompCont.on(
            $.AnyPicker.extra.sEndEv + '.' + apo.setting.timestamp,
            oData,
            apo._onEndDrag
          );
        if ($.CF.isValid($.AnyPicker.extra.sOutEv))
          $oCompCont.on(
            $.AnyPicker.extra.sOutEv + '.' + apo.setting.timestamp,
            oData,
            apo._onEndDrag
          );
        ...
        if ($.AnyPicker.extra.sMouseWheel.length > 0) {
          for (
            var iEventIndex = 0;
            iEventIndex < $.AnyPicker.extra.sMouseWheel.length;
            iEventIndex++
          )
            $oCompCont.on(
              $.AnyPicker.extra.sMouseWheel[iEventIndex] +
                '.' +
    ...
    adjustComponents: function() {
      ...
      $overlaySelector
        .find('.ap-row, .ap-component-selector')
        .css({
    ...
    _onStartDrag: function(e) {
      ...
      if (!apo.tmp.bIsManualDragging) apo.tmp.bIsManualDragging = true;
      ...
      if ($.CF.compareStrings(apo.setting.theme, 'Windows')) {
        var $oComp = $(apo.tmp.overlaySelector).find(
    ...
    _setScrollingData: function(e) {
      ...
      apo.tmp.oScrollingComp = $('#ap-component-' + e.data.component).find(
        '.ap-component-data'
      );
      apo.tmp.iMinTopPos = 0;
      apo.tmp.iMaxTopPos =
        $(apo.tmp.oScrollingComp).find('.ap-row').length *
          apo.setting.rowHeight -
        $(apo.tmp.oScrollingComp)
          .parent()
          .innerHeight();
	...
	*/
    ...
    _performTransition: function(
      ...
      var apo = this;
      var oElem = $(apo.tmp.overlaySelector)
          .find(sComp)
          .get(0),
      ...
      if ($.AnyPicker.extra.bHasCSS3D) {
        oElem.style[$.AnyPicker.extra.sCSSTransition] =
          $.AnyPicker.extra.sCSSTransformStyle + ' ' + iTime + 's ease-out';
        oElem.style[$.AnyPicker.extra.sCSSTransform] =
          'translate3d(0px, ' + -iOffset + 'px, 0px)';
      } else $(oElem).animate({ top: -iOffset }, 100);
    ...
    _performTransitionAfter: function(
      ...
      setTimeout(function() {
        ...
        if (bLTMin || bGTMax) {
          ...
          } else $(oElem).animate({ top: -Math.abs(iOffset) }, 100);
    ...
    _getOffset: function(oElem, bAbs) {
      var sMatrix = $(oElem).hasClass('ap-component-data')
          ? $(oElem).css('transform')
          : $(oElem)
    ...
    __scrollToSelectedRow: function() {
      ...
      for (iTempIndex = 0; iTempIndex < apo.tmp.numOfComp; iTempIndex++) {
        var oArrSelected = $(apo.tmp.overlaySelector).find(
	...
	*/
    ...
    _actionsOnComponentStop: function(sSource, iComp, iRow, iOffset, iDir) {
      ...
      if (apo.tmp.sHeaderTitleType === 'DynamicFunction') {
        ...
        if (!apo.tmp.bIsManualDragging)
          // !$.CF.compareStrings(apo.setting.theme, "iOS") &&
	...
	*/
    ...
    __setAriaSelectedForRowElement: function(iComp, iOffset, iDir) {
      var apo = this;
      var $oElemComp = $(apo.tmp.overlaySelector).find(
          '#ap-component-' + iComp
        ),
        iElementIndex;
    ...
    _getSelectedValueInComponent: function(iComp) {
      ...
      if ($.CF.isValid(iComp)) {
        $oSelectedElem = $(apo.tmp.overlaySelector).find(
      ...
      if (apo.setting.dataSource === null) {
        if (apo.tmp.oElemValid.bIsListItem || apo.tmp.oElemValid.bIsSelect) {
          ...
          if (
            ...
            $.CF.isValid(apo.setting.headerTitle.format)
          ) {
	...
	*/
    ...
    __setDataSourceArrayForComponent: function(sCompName, sCompFormat) {
      ...
      if (sCompName === 'day') {
        if (sCompFormat === 'DD') {
          for (
            iTempIndex = 0;
            iTempIndex < $.AnyPicker.extra.en.veryShortDays.length;
            iTempIndex++
          ) {
            oArrData.push({
              val: iTempIndex,
          ...
          for (
            iTempIndex = 0;
            iTempIndex < $.AnyPicker.extra.en.shortDays.length;
            iTempIndex++
          ) {
            oArrData.push({
              val: iTempIndex,
          ...
          for (
            iTempIndex = 0;
            iTempIndex < $.AnyPicker.extra.en.fullDays.length;
            iTempIndex++
          ) {
            oArrData.push({
              val: iTempIndex,
        ...
        if ($.CF.isValid(oMin)) iStartValue = oMin.y;
        else
          iStartValue =
            iTotalYears % 2 === 0
        ...
        if ($.CF.isValid(oMax)) iEndValue = oMax.y;
    ...
    _getRegexComponentForFormat: function(sInRegex, sFormat) {
      ...
      if (sFormat === 'd' || sFormat === 'dd') {
        ...
        $.CF.compareStrings(sFormat, 'y') ||
        $.CF.compareStrings(sFormat, 'yyyy')
      ) {
        sInRegex += '(\\d{1,4})';
      } else if ($.CF.compareStrings(sFormat, 'yy')) {
        sInRegex += '(\\d{2})';
      } else if (
        $.CF.compareStrings(sFormat, 'h') ||
        $.CF.compareStrings(sFormat, 'hh')
      ) {
        sInRegex += '(\\d{1,2})';
      } else if (sFormat === 'm' || sFormat === 'mm') {
        sInRegex += '(\\d{1,2})';
    ...
    _parseInputDateTime: function(sDate) {
      ...
      if (typeof sDate === 'string') {
        ...
        if ($.CF.isValid(oDate.h)) {
          if (
            ($.CF.compareStrings(oDate.me, 'AM') ||
              $.CF.compareStrings(oDate.sm, 'A')) &&
            oDate.h === 12
          )
            oDate.H = 0;
          else if (
            ($.CF.compareStrings(oDate.me, 'PM') ||
              $.CF.compareStrings(oDate.sm, 'P')) &&
            oDate.h < 12
          )
            oDate.H = oDate.h + 12;
    ...
    _setInputDateTimeValue: function(
      ...
      if (apo._isSupportedFormat(sDateTimeFormat)) {
        if (sDateTimeFormat === 'd' || sDateTimeFormat === 'dd') {
          ...
          $.CF.compareStrings(sDateTimeFormat, 'y') ||
          $.CF.compareStrings(sDateTimeFormat, 'yyyy')
        ) {
          oThisDate.y = parseInt(sDateTimeValue);
    ...
    parseDisableValues: function() {
      ...
      if ($.CF.isValid(apo.setting.disableValues)) {
        ...
        if (
          $.CF.isValid(apo.setting.disableValues.day) &&
        ...
        if (
          $.CF.isValid(apo.setting.disableValues.date) &&
        ...
        if (
          $.CF.isValid(apo.setting.disableValues.time) &&
          ...
          for (
            ...
            var oDayTime = apo.setting.disableValues.time[iTempIndex1],
              bIsValidDay =
                $.CF.isValid(oDayTime.day) && oDayTime.day.length > 0,
              bIsValidVal =
                $.CF.isValid(oDayTime.val) && oDayTime.val.length > 0;
            ...
            if (bIsValidVal) {
              ...
              for (
                ...
                if ($.CF.isValid(oOutTime)) oArrTimes.push(oOutTime);
              }
        ...
        if (
          $.CF.isValid(apo.setting.disableValues.datetime) &&
    ...
    __getSelectedDate: function(bGetObject) {
      ...
      for (iTempIndex = 0; iTempIndex < apo.tmp.numOfComp; iTempIndex++) {
        oComp = apo.setting.components[iTempIndex];
        oArrSelected = $(apo.tmp.overlaySelector).find(
          '#ap-component-' + iTempIndex + ' .ap-row-selected'
        );
        oElemSelected = oArrSelected.length > 0 ? oArrSelected[0] : null;
	...
	*/
        ...
        if (
          ...
          for (
            ...
            if ($.CF.isValid(oDateRecord.val)) {
              ...
              $.CF.isValid(oDateRecord.start) &&
              $.CF.isValid(oDateRecord.end)
            ) {
              if (
              ...
              $.CF.isValid(oDateRecord.min) &&
              $.CF.isValid(oDateRecord.max)
            ) {
            ...
            if (bIsValidDay) {
              for (
                ...
                if ($.CF.isValid(oTimeRecord.val)) {
                  ...
                  $.CF.isValid(oTimeRecord.start) &&
                  $.CF.isValid(oTimeRecord.end)
                ) {
                  if (
                  ...
                  $.CF.isValid(oTimeRecord.min) &&
                  $.CF.isValid(oTimeRecord.max)
                ) {
                  bLTMin =
    ...
    _findValidSelectedDate: function(bIsBefore, dDate, sType) {
      ...
      if (sType === 'day' || sType === 'date') {
        if (
          $.CF.isValid(apo.setting.minValue) &&
        ...
        if (
          $.CF.isValid(apo.setting.maxValue) &&
        ...
        do {
          ...
          else dDate = new Date(dDate.getTime() + $.AnyPicker.extra.iMS.d);
        ...
        do {
          if (bIsBefore)
            dDate = new Date(
              dDate.getTime() -
                $.AnyPicker.extra.iMS.m * apo.setting.intervals.m
            );
          else
            dDate = new Date(
              dDate.getTime() +
    ...
    __setDaysOfMonthInDatePicker: function() {
      ...
      if (iDateComp !== null) {
        ...
        for (iTempIndex = iNoOfDays + 1; iTempIndex <= 31; iTempIndex++) {
          var $oHiddenElem = $('#ap-component-' + iDateComp).find(
        ...
        oInput.iDate = {
          ...
          M:
            oInput.iDate.M !== undefined
              ? oInput.iDate.M
              : $.AnyPicker.extra.dToday.getMonth(),
          y:
            oInput.iDate.y !== undefined
              ? oInput.iDate.y
              : $.AnyPicker.extra.dToday.getFullYear(),
    ...
    convertToUTC: function(dIpDate, sIpTZOffset) {
      ...
      return new Date(
        dIpDate.getTime() -
          ...
          sIpTZOffset === '' ||
          sIpTZOffset === null
            ? -(dIpDate.getTimezoneOffset() * $.AnyPicker.extra.iMS.m)
    ...
    _getTZOffsetInMS: function(sTZOffset) {
      ...
      if (sTZOffset === undefined || sTZOffset === '' || sTZOffset === null)
        iOffsetMS = -(
          $.AnyPicker.extra.dToday.getTimezoneOffset() * $.AnyPicker.extra.iMS.m
        );
      else {
        ...
        iOffsetMS =
          parseInt(sArrTZOffset[2]) * $.AnyPicker.extra.iMS.h +
          parseInt(sArrTZOffset[3]) * $.AnyPicker.extra.iMS.m;
    ...
    _getDifference: function(sUnit, dDate1, dDate2) {
      ...
      else if (sUnit === 's') iUnitDiff = iMSDiff / $.AnyPicker.extra.iMS.s;
      else if (sUnit === 'm') iUnitDiff = iMSDiff / $.AnyPicker.extra.iMS.m;
      else if (sUnit === 'h') iUnitDiff = iMSDiff / $.AnyPicker.extra.iMS.h;
      else if (sUnit === 'd') iUnitDiff = iMSDiff / $.AnyPicker.extra.iMS.d;
      else if (sUnit === 'M') iUnitDiff = iMSDiff / $.AnyPicker.extra.iMS.m;
      else if (sUnit === 'y') iUnitDiff = iMSDiff / $.AnyPicker.extra.iMS.y;
