    ...
    class HeroElement extends HTMLElement {
      ...
      _in(json){
          ...
          if (json.name) {
            ...
            if (this.json.yOffset) {
              ...
              if (top) {
                ...
                if (!top.heroLayoutListenners) { top.heroLayoutListenners = [];}            if (!APP.contain(top.heroLayoutListenners,this)) {
        ...
        if (this.json.center) {
          ...
          }    }    if (json.autolayout) ;    if (json.raised) {
    ...
    class HeroPages extends HeroElement{
        ...
        on(json){
    		...
    		const curCallback = (function() {
    			...
    			if( this.endNextPage ) {
    				this.onEndAnimation( this.currPage, this.nextPage, this.outClass, this.inClass );
    			}
    		}).bind(this);
        ...
        if (Array.isArray(json)) {
          ...
          for(var num in views){
            ...
            if(view.in){
              this.heroContent.appendChild(view);
              view.controller = this;
              if (viewObject.frame) ;          view.in(viewObject);
            }else{
              console.log(viewObject.class||viewObject.res);
            }
          }
