    ...
    (function(t) {
      ...
      function(t, r, e) {
        ...
        (function(t, i) {
          ...
          function s(r, e) {
            ...
            return (
              t.TYPED_ARRAY_SUPPORT
                ? ((r = new Uint8Array(e)), (r.__proto__ = t.prototype))
                : (null === r && (r = new t(e)), (r.length = e)),
              r
            );
          }
          function t(r, e, i) {
          ...
          function f(r, e) {
            if (
              (u(e), (r = s(r, 0 > e ? 0 : 0 | m(e))), !t.TYPED_ARRAY_SUPPORT)
            )
              for (var i = 0; e > i; ++i) r[i] = 0;
            return r;
          }
          function l(r, e, i) {
            if (
          ...
          function c(t, r) {
            var e = 0 > r.length ? 0 : 0 | m(r.length);
            t = s(t, e);
            for (var i = 0; e > i; i += 1) t[i] = 255 & r[i];
            return t;
          }
          function p(r, e, i, n) {
            if (0 > i || i > e.byteLength)
              throw new RangeError("'offset' is out of bounds");
            if (i + (n || 0) > e.byteLength)
          ...
          function d(r, e) {
            if (t.isBuffer(e)) {
              var i = 0 | m(e.length);
              return (
                (r = s(r, i)), 0 === r.length ? r : (e.copy(r, 0, 0, i), r)
              );
            }
            if (e) {
              if (
                ...
                return 'number' != typeof e.length || W(e.length)
                  ? s(r, 0)
                  : c(r, e);
              if ('Buffer' === e.type && X(e.data)) return c(r, e.data);
            }
            throw new TypeError(
            ...
            for (var n = !1; ; )
              switch (e) {
                ...
                case 'base64':
                  return K(r).length;
                default:
                  if (n) return z(r).length;
                  (e = ('' + e).toLowerCase()), (n = !0);
              }
          }
          function y(t, r, e) {
            var i = !1;
            if (((void 0 === r || 0 > r) && (r = 0), r > this.length))
              return '';
            if (
              ((void 0 === e || e > this.length) && (e = this.length), 0 >= e)
            )
              return '';
          ...
          function M(r, e, i, n, o) {
            ...
            if (('string' == typeof e && (e = t.from(e, n)), t.isBuffer(e)))
              return 0 === e.length ? -1 : b(r, e, i, n, o);
            if ('number' == typeof e)
              return (
                (e = 255 & e),
                t.TYPED_ARRAY_SUPPORT &&
                'function' == typeof Uint8Array.prototype.indexOf
                  ? o
                    ? Uint8Array.prototype.indexOf.call(r, e, i)
                    : Uint8Array.prototype.lastIndexOf.call(r, e, i)
                  : b(r, [e], i, n, o)
              );
          ...
          function b(t, r, e, i, n) {
            ...
            if (n) {
              var f = -1;
              for (a = e; h > a; a++)
                if (o(t, a) === o(r, f === -1 ? 0 : a - f)) {
                  if ((f === -1 && (f = a), a - f + 1 === u)) return f * s;
                } else f !== -1 && (a -= a - f), (f = -1);
            } else
              for (e + u > h && (e = h - u), a = e; a >= 0; a--) {
                for (var l = !0, c = 0; u > c; c++)
                  if (o(t, a + c) !== o(r, c)) {
                    l = !1;
                    break;
                  }
          ...
          function B(t, r, e, i) {
            return $(J(r, t.length - e), t, e, i);
          }
          function T(t, r, e) {
            return V.fromByteArray(
              0 === r && e === t.length ? t : t.slice(r, e)
            );
          }
          function k(t, r, e) {
          ...
          function j(t) {
            var r = t.length;
            if (tt >= r) return String.fromCharCode.apply(String, t);
            for (var e = '', i = 0; r > i; )
              e += String.fromCharCode.apply(String, t.slice(i, (i += tt)));
            return e;
          }
          function D(t, r, e) {
            var i = '';
            e = Math.min(t.length, e);
            for (var n = r; e > n; ++n) i += String.fromCharCode(127 & t[n]);
            return i;
          }
          function P(t, r, e) {
            var i = '';
            e = Math.min(t.length, e);
            for (var n = r; e > n; ++n) i += String.fromCharCode(t[n]);
            return i;
          }
          function R(t, r, e) {
            var i = t.length;
            (r && r >= 0) || (r = 0), (!e || 0 > e || e > i) && (e = i);
            for (var n = '', o = r; e > o; ++o) n += Y(t[o]);
            return n;
          }
          function O(t, r, e) {
            for (var i = t.slice(r, e), n = '', o = 0; i.length > o; o += 2)
          ...
          function I(r, e, i, n, o, s) {
            ...
            if (i + n > r.length) throw new RangeError('Index out of range');
          }
          function Q(t, r, e, i) {
            0 > r && (r = 65535 + r + 1);
            for (var n = 0, o = Math.min(t.length - e, 2); o > n; ++n)
              t[e + n] =
                (r & (255 << (8 * (i ? n : 1 - n)))) >>> (8 * (i ? n : 1 - n));
          }
          function N(t, r, e, i) {
            0 > r && (r = 4294967295 + r + 1);
            for (var n = 0, o = Math.min(t.length - e, 4); o > n; ++n)
          ...
          function q(t, r, e, i, n) {
            return (
              n || U(t, r, e, 4, 3.4028234663852886e38, -3.4028234663852886e38),
              G.write(t, r, e, i, 23, 4),
              e + 4
            );
          }
          function L(t, r, e, i, n) {
            return (
              n ||
                U(t, r, e, 8, 1.7976931348623157e308, -1.7976931348623157e308),
              G.write(t, r, e, i, 52, 8),
              e + 8
            );
          }
          function F(t) {
            if (((t = H(t).replace(rt, '')), 2 > t.length)) return '';
            for (; t.length % 4 !== 0; ) t += '=';
            return t;
          }
          function H(t) {
          ...
          function z(t, r) {
            r = r || 1 / 0;
            for (var e, i = t.length, n = null, o = [], s = 0; i > s; ++s) {
              ...
              if (((n = null), 128 > e)) {
                ...
                if (e >= 1114112) throw Error('Invalid code point');
                if ((r -= 4) < 0) break;
                o.push(
                  (e >> 18) | 240,
                  ((e >> 12) & 63) | 128,
          ...
          function Z(t) {
            for (var r = [], e = 0; t.length > e; ++e)
              r.push(255 & t.charCodeAt(e));
            return r;
          }
          function J(t, r) {
            for (var e, i, n, o = [], s = 0; t.length > s && (r -= 2) >= 0; ++s)
              (e = t.charCodeAt(s)),
                (i = e >> 8),
                (n = e % 256),
                o.push(n),
          ...
          function $(t, r, e, i) {
            for (var n = 0; i > n && (n + e < r.length && n < t.length); ++n)
              r[n + e] = t[n];
            return n;
          }
          function W(t) {
          ...
          (r.Buffer = t),
            ...
            (t.TYPED_ARRAY_SUPPORT =
              void 0 !== i.TYPED_ARRAY_SUPPORT ? i.TYPED_ARRAY_SUPPORT : n()),
            (r.kMaxLength = o()),
            (t.poolSize = 8192),
            (t._augment = function(r) {
              return (r.__proto__ = t.prototype), r;
            }),
            (t.from = function(t, r, e) {
              return h(null, t, r, e);
            }),
            t.TYPED_ARRAY_SUPPORT &&
            ...
            (t.compare = function(r, e) {
              if (!t.isBuffer(r) || !t.isBuffer(e))
                throw new TypeError('Arguments must be Buffers');
              if (r === e) return 0;
              for (
                var i = r.length, n = e.length, o = 0, s = Math.min(i, n);
                s > o;
                ++o
              )
                if (r[o] !== e[o]) {
            ...
            (t.concat = function(r, e) {
              ...
              if (0 === r.length) return t.alloc(0);
              var i;
              if (void 0 === e)
                for (e = 0, i = 0; r.length > i; ++i) e += r[i].length;
              var n = t.allocUnsafe(e),
                o = 0;
            ...
            (t.prototype.swap16 = function() {
              ...
              for (var r = 0; t > r; r += 2) w(this, r, r + 1);
              return this;
            }),
            ...
            (t.prototype.compare = function(r, e, i, n, o) {
              if (!t.isBuffer(r))
                throw new TypeError('Argument must be a Buffer');
              if (
                (void 0 === e && (e = 0),
                void 0 === i && (i = r ? r.length : 0),
                void 0 === n && (n = 0),
                void 0 === o && (o = this.length),
                0 > e || i > r.length || 0 > n || o > this.length)
              )
                throw new RangeError('out of range index');
              if (n >= o && e >= i) return 0;
              if (n >= o) return -1;
              if (e >= i) return 1;
              if (((e >>>= 0), (i >>>= 0), (n >>>= 0), (o >>>= 0), this === r))
                return 0;
              for (
                var s = o - n,
                  h = i - e,
            ...
            (t.prototype.includes = function(t, r, e) {
              return this.indexOf(t, r, e) !== -1;
            }),
            (t.prototype.indexOf = function(t, r, e) {
              return M(this, t, r, e, !0);
            }),
            (t.prototype.lastIndexOf = function(t, r, e) {
              return M(this, t, r, e, !1);
            }),
            (t.prototype.write = function(t, r, e, i) {
          ...
          (t.prototype.slice = function(r, e) {
            ...
            (r = ~~r),
              (e = void 0 === e ? i : ~~e),
              0 > r ? ((r += i), 0 > r && (r = 0)) : r > i && (r = i),
              0 > e ? ((e += i), 0 > e && (e = 0)) : e > i && (e = i),
              r > e && (e = r);
            var n;
            if (t.TYPED_ARRAY_SUPPORT)
              (n = this.subarray(r, e)), (n.__proto__ = t.prototype);
            else {
              var o = e - r;
              n = new t(o, void 0);
              for (var s = 0; o > s; ++s) n[s] = this[s + r];
            }
            return n;
          }),
            ...
            (t.prototype.readFloatLE = function(t, r) {
              return r || C(t, 4, this.length), G.read(this, t, !0, 23, 4);
            }),
            (t.prototype.readFloatBE = function(t, r) {
              return r || C(t, 4, this.length), G.read(this, t, !1, 23, 4);
            }),
            (t.prototype.readDoubleLE = function(t, r) {
              return r || C(t, 8, this.length), G.read(this, t, !0, 52, 8);
            }),
            (t.prototype.readDoubleBE = function(t, r) {
              return r || C(t, 8, this.length), G.read(this, t, !1, 52, 8);
            }),
            (t.prototype.writeUIntLE = function(t, r, e, i) {
              if (((t = +t), (r = 0 | r), (e = 0 | e), !i)) {
            ...
            (t.prototype.writeUIntBE = function(t, r, e, i) {
              if (((t = +t), (r = 0 | r), (e = 0 | e), !i)) {
                var n = Math.pow(2, 8 * e) - 1;
                I(this, t, r, e, n, 0);
              }
            ...
            (t.prototype.writeUInt8 = function(r, e, i) {
              return (
                (r = +r),
                (e = 0 | e),
                i || I(this, r, e, 1, 255, 0),
                t.TYPED_ARRAY_SUPPORT || (r = Math.floor(r)),
                (this[e] = 255 & r),
                e + 1
              );
            }),
            (t.prototype.writeUInt16LE = function(r, e, i) {
              return (
                (r = +r),
                (e = 0 | e),
                i || I(this, r, e, 2, 65535, 0),
                t.TYPED_ARRAY_SUPPORT
            ...
            (t.prototype.writeUInt16BE = function(r, e, i) {
              return (
                (r = +r),
                (e = 0 | e),
                i || I(this, r, e, 2, 65535, 0),
                t.TYPED_ARRAY_SUPPORT
                  ? ((this[e] = r >>> 8), (this[e + 1] = 255 & r))
                  : Q(this, r, e, !1),
                e + 2
              );
            }),
            (t.prototype.writeUInt32LE = function(r, e, i) {
              return (
                (r = +r),
                (e = 0 | e),
                i || I(this, r, e, 4, 4294967295, 0),
                t.TYPED_ARRAY_SUPPORT
                  ? ((this[e + 3] = r >>> 24),
                    (this[e + 2] = r >>> 16),
                    (this[e + 1] = r >>> 8),
            ...
            (t.prototype.writeUInt32BE = function(r, e, i) {
              return (
                (r = +r),
                (e = 0 | e),
                i || I(this, r, e, 4, 4294967295, 0),
            ...
            (t.prototype.writeIntLE = function(t, r, e, i) {
              if (((t = +t), (r = 0 | r), !i)) {
                var n = Math.pow(2, 8 * e - 1);
                I(this, t, r, e, n - 1, -n);
              }
              ...
              for (this[r] = 255 & t; ++o < e && (s *= 256); )
                0 > t && 0 === h && 0 !== this[r + o - 1] && (h = 1),
                  (this[r + o] = (((t / s) >> 0) - h) & 255);
              return r + e;
            }),
            (t.prototype.writeIntBE = function(t, r, e, i) {
              if (((t = +t), (r = 0 | r), !i)) {
                var n = Math.pow(2, 8 * e - 1);
                I(this, t, r, e, n - 1, -n);
              }
            ...
            (t.prototype.writeInt8 = function(r, e, i) {
              return (
                (r = +r),
                (e = 0 | e),
                i || I(this, r, e, 1, 127, -128),
                t.TYPED_ARRAY_SUPPORT || (r = Math.floor(r)),
                0 > r && (r = 255 + r + 1),
                (this[e] = 255 & r),
                e + 1
            ...
            (t.prototype.writeInt16LE = function(r, e, i) {
              return (
                (r = +r),
                (e = 0 | e),
                i || I(this, r, e, 2, 32767, -32768),
                t.TYPED_ARRAY_SUPPORT
                  ? ((this[e] = 255 & r), (this[e + 1] = r >>> 8))
                  : Q(this, r, e, !0),
                e + 2
            ...
            (t.prototype.writeInt16BE = function(r, e, i) {
              return (
                (r = +r),
                (e = 0 | e),
                i || I(this, r, e, 2, 32767, -32768),
            ...
            (t.prototype.writeInt32LE = function(r, e, i) {
              return (
                (r = +r),
                (e = 0 | e),
                i || I(this, r, e, 4, 2147483647, -2147483648),
                t.TYPED_ARRAY_SUPPORT
                  ? ((this[e] = 255 & r),
                    (this[e + 1] = r >>> 8),
                    (this[e + 2] = r >>> 16),
            ...
            (t.prototype.writeInt32BE = function(r, e, i) {
              return (
                (r = +r),
                (e = 0 | e),
                i || I(this, r, e, 4, 2147483647, -2147483648),
            ...
            (t.prototype.copy = function(r, e, i, n) {
              if (
                (i || (i = 0),
                n || 0 === n || (n = this.length),
              ...
              n > this.length && (n = this.length),
                n - i > r.length - e && (n = r.length - e + i);
              var o,
                s = n - i;
              if (this === r && e > i && n > e)
                for (o = s - 1; o >= 0; --o) r[o + e] = this[o + i];
              else if (1e3 > s || !t.TYPED_ARRAY_SUPPORT)
                for (o = 0; s > o; ++o) r[o + e] = this[o + i];
              else Uint8Array.prototype.set.call(r, this.subarray(i, i + s), e);
              return s;
            }),
            (t.prototype.fill = function(r, e, i, n) {
              if ('string' == typeof r) {
                if (
                  ('string' == typeof e
              ...
              } else 'number' == typeof r && (r = 255 & r);
              if (0 > e || e > this.length || i > this.length)
                throw new RangeError('Out of range index');
              if (e >= i) return this;
              (e >>>= 0),
                ...
                r || (r = 0);
              var s;
              if ('number' == typeof r) for (s = e; i > s; ++s) this[s] = r;
              else {
                var h = t.isBuffer(r) ? r : z('' + new t(r, n)),
                  u = h.length;
                for (s = 0; i - e > s; ++s) this[s + e] = h[s % u];
              }
              return this;
            });
          var rt = /[^+\/0-9A-Za-z-_]/g;
        }.call(r, e(0).Buffer, e(8)));
      },
      function(t, r, e) {
        (function(t) {
          !(function(t, r) {
            ...
            function s(t, r, e) {
              for (var i = 0, n = Math.min(t.length, e), o = r; n > o; o++) {
            ...
            function h(t, r, e, i) {
              for (var n = 0, o = Math.min(t.length, e), s = r; o > s; s++) {
                var h = t.charCodeAt(s) - 48;
                (n *= i),
                  (n += 49 > h ? (17 > h ? h : h - 17 + 10) : h - 49 + 10);
              }
              return n;
            }
            function u(t) {
              for (var r = Array(t.bitLength()), e = 0; r.length > e; e++) {
                var i = (e / 26) | 0,
                  n = e % 26;
                r[e] = (t.words[i] & (1 << n)) >>> n;
              }
            ...
            function f(t, r, e) {
              ...
              for (var i = 0, n = 0, o = 0; e.length - 1 > o; o++) {
                var s = n;
                n = 0;
                for (
                  var h = 67108863 & i,
            ...
            (o.isBN = function(t) {
              ...
              (o.prototype._initArray = function(t, r, e) {
                if ((i('number' == typeof t.length), 0 >= t.length))
              ...
              (o.prototype._parseHex = function(t, r) {
                (this.length = Math.ceil((t.length - r) / 6)),
                  (this.words = Array(this.length));
                for (var e = 0; this.length > e; e++) this.words[e] = 0;
                var i,
                  n,
                  o = 0;
              ...
              (o.prototype._parseBase = function(t, r, e) {
                ...
                for (var i = 0, n = 1; 67108863 >= n; n *= r) i++;
                i--, (n = (n / r) | 0);
                for (
                  var o = t.length - e,
                    s = o % i,
                  ...
                  (a = h(t, f, f + i, r)),
                    this.imuln(n),
                    67108864 > this.words[0] + a
                      ? (this.words[0] += a)
                      : this._iaddn(a);
                if (0 !== s) {
                  var l = 1;
                  for (a = h(t, f, t.length, r), f = 0; s > f; f++) l *= r;
                  this.imuln(l),
                    67108864 > this.words[0] + a
                      ? (this.words[0] += a)
                      : this._iaddn(a);
            ...
            (o.prototype.toString = function(t, r) {
              ...
              if (16 === t || 'hex' === t) {
                e = '';
                for (var n = 0, o = 0, s = 0; this.length > s; s++) {
                  var h = this.words[s],
              ...
              if (t === (0 | t) && t >= 2 && 36 >= t) {
                ...
                for (l.negative = 0; !l.isZero(); ) {
                  var c = l.modn(f).toString(t);
                  (l = l.idivn(f)),
                    (e = l.isZero() ? c + e : _[a - c.length] + c + e);
                }
              ...
              (o.prototype.toBuffer = function(t, r) {
                return i(void 0 !== M), this.toArrayLike(M, t, r);
              }),
              ...
              (o.prototype.toArrayLike = function(t, r, e) {
                var n = this.byteLength(),
                  o = e || Math.max(1, n);
                i(o >= n, 'byte array longer than desired length'),
              ...
              (o.prototype.zeroBits = function() {
                ...
                for (var t = 0, r = 0; this.length > r; r++) {
              ...
              (o.prototype.iuor = function(t) {
                for (; t.length > this.length; ) this.words[this.length++] = 0;
              ...
              (o.prototype.iuxor = function(t) {
                ...
                if (this !== r)
                  for (; r.length > i; i++) this.words[i] = r.words[i];
                return (this.length = r.length), this.strip();
              }),
              ...
              (o.prototype.iadd = function(t) {
                ...
                if (((this.length = e.length), 0 !== n))
                  ...
                  for (; e.length > o; o++) this.words[o] = e.words[o];
                return this;
              }),
              ...
              (o.prototype.isub = function(t) {
                ...
                for (var o = 0, s = 0; n.length > s; s++)
                  (r = (0 | i.words[s]) - (0 | n.words[s]) + o),
                    (o = r >> 26),
                    (this.words[s] = 67108863 & r);
                for (; 0 !== o && i.length > s; s++)
                  (r = (0 | i.words[s]) + o),
                    (o = r >> 26),
                    (this.words[s] = 67108863 & r);
                if (0 === o && i.length > s && i !== this)
                  for (; i.length > s; s++) this.words[s] = i.words[s];
                return (
            ...
            Math.imul || (x = a),
              ...
              (c.prototype.revBin = function(t, r, e) {
                if (0 === t || t === e - 1) return t;
                for (var i = 0, n = 0; r > n; n++)
                  (i |= (1 & t) << (r - n - 1)), (t >>= 1);
                return i;
              }),
              (c.prototype.permute = function(t, r, e, i, n, o) {
                for (var s = 0; o > s; s++) (i[s] = r[t[s]]), (n[s] = e[t[s]]);
              }),
              (c.prototype.transform = function(t, r, e, i, n, o) {
              ...
              (c.prototype.conjugate = function(t, r, e) {
                if (e > 1)
                  for (var i = 0; e / 2 > i; i++) {
                    var n = t[i];
                    (t[i] = t[e - i - 1]),
              ...
              (c.prototype.normalize13b = function(t, r) {
                for (var e = 0, i = 0; r / 2 > i; i++) {
                  var n =
                    8192 * Math.round(t[2 * i + 1] / r) +
                    Math.round(t[2 * i] / r) +
                    e;
                  (t[i] = 67108863 & n),
                    (e = 67108864 > n ? 0 : (n / 67108864) | 0);
                }
                return t;
              }),
              (c.prototype.convert13b = function(t, r, e, n) {
                for (var o = 0, s = 0; r > s; s++)
                  (o += 0 | t[s]),
                    (e[2 * s] = 8191 & o),
                    (o >>>= 13),
                    (e[2 * s + 1] = 8191 & o),
                    (o >>>= 13);
                for (s = 2 * r; n > s; ++s) e[s] = 0;
                i(0 === o), i(0 === (o & -8192));
              }),
              (c.prototype.stub = function(t) {
                for (var r = Array(t), e = 0; t > e; e++) r[e] = 0;
                return r;
              }),
              (c.prototype.mulp = function(t, r, e) {
              ...
              (o.prototype.mul = function(t) {
                var r = new o(null);
                return (
                  (r.words = Array(this.length + t.length)), this.mulTo(t, r)
                );
              }),
              (o.prototype.mulf = function(t) {
                var r = new o(null);
                return (r.words = Array(this.length + t.length)), l(this, t, r);
              }),
              (o.prototype.imul = function(t) {
                return this.clone().mulTo(t, this);
              }),
              (o.prototype.imuln = function(t) {
                i('number' == typeof t), i(67108864 > t);
                for (var r = 0, e = 0; this.length > e; e++) {
              ...
              (o.prototype.pow = function(t) {
                ...
                if (++i < r.length)
                  for (var n = e.sqr(); r.length > i; i++, n = n.sqr())
                    0 !== r[i] && (e = e.mul(n));
                return e;
              }),
              ...
              (o.prototype.iushrn = function(t, r, e) {
                ...
                if (((n -= s), (n = Math.max(0, n)), u)) {
                  for (var a = 0; s > a; a++) u.words[a] = this.words[a];
                  u.length = s;
                }
                if (0 === s);
                else if (this.length > s)
                  for (this.length -= s, a = 0; this.length > a; a++)
                    this.words[a] = this.words[a + s];
                else (this.words[0] = 0), (this.length = 1);
                var f = 0;
                for (a = this.length - 1; !(0 > a || (0 === f && n > a)); a--) {
              ...
              (o.prototype._iaddn = function(t) {
                ...
                for (
                  var r = 0;
                  this.length > r && this.words[r] >= 67108864;
                  r++
                )
              ...
              (o.prototype.isubn = function(t) {
                if ((i('number' == typeof t), i(67108864 > t), 0 > t))
                  return this.iaddn(-t);
                if (0 !== this.negative)
                  return (
                    (this.negative = 0),
                ...
                if (
                  ((this.words[0] -= t), 1 === this.length && 0 > this.words[0])
                )
                  (this.words[0] = -this.words[0]), (this.negative = 1);
                else
                  for (var r = 0; this.length > r && 0 > this.words[r]; r++)
              ...
              (o.prototype._ishlnsubmul = function(t, r, e) {
                ...
                for (n = 0; t.length > n; n++) {
                  s = (0 | this.words[n + e]) + h;
                  var u = (0 | t.words[n]) * r;
                  (s -= 67108863 & u),
                    (h = (s >> 26) - ((u / 67108864) | 0)),
                    (this.words[n + e] = 67108863 & s);
                }
                for (; this.length - e > n; n++)
                  (s = (0 | this.words[n + e]) + h),
                    (h = s >> 26),
                    (this.words[n + e] = 67108863 & s);
                if (0 === h) return this.strip();
                for (i(h === -1), h = 0, n = 0; this.length > n; n++)
                  (s = -(0 | this.words[n]) + h),
                    (h = s >> 26),
              ...
              (o.prototype._wordDiv = function(t, r) {
                ...
                if ('mod' !== r) {
                  ...
                  for (var f = 0; u.length > f; f++) u.words[f] = 0;
                }
              ...
              (o.prototype.modn = function(t) {
                i(67108863 >= t);
                for (
                  var r = (1 << 26) % t, e = 0, n = this.length - 1;
                  n >= 0;
                  n--
                )
              ...
              (o.prototype._invmp = function(t) {
                ...
                r = 0 !== r.negative ? r.umod(t) : r.clone();
                for (
                  var n = new o(1), s = new o(0), h = e.clone();
                ...
                var c;
                return (
                  (c = 0 === r.cmpn(1) ? n : s), c.cmpn(0) < 0 && c.iadd(t), c
                );
              }),
              ...
              (o.prototype.bincn = function(t) {
                ...
                for (var o = n, s = e; 0 !== o && this.length > s; s++) {
              ...
              (o.prototype.cmpn = function(t) {
                ...
                if (this.length > 1) e = 1;
                  ...
                  r && (t = -t), i(67108863 >= t, 'Number is too big');
            ...
            (p.prototype._tmp = function() {
              ...
              (p.prototype.ireduce = function(t) {
                ...
                do
                  this.split(e, this.tmp),
                    ...
                    (r = e.bitLength());
                while (r > this.n);
                var i = this.n > r ? -1 : e.ucmp(this.p);
                return (
                  0 === i
              ...
              (p.prototype.split = function(t, r) {
                t.iushrn(this.n, 0, r);
              }),
              ...
              n(d, p),
              (d.prototype.split = function(t, r) {
                for (
                  ...
                  r.words[n] = t.words[n];
                if (((r.length = i), 9 >= t.length))
                  return (t.words[0] = 0), void (t.length = 1);
                var o = t.words[9];
                for (r.words[r.length++] = o & e, n = 10; t.length > n; n++) {
                  var s = 0 | t.words[n];
              ...
              (o._prime = function B(t) {
                if (S[t]) return S[t];
                var B;
                if ('k256' === t) B = new d();
                else if ('p224' === t) B = new m();
                else if ('p192' === t) B = new g();
                else {
              ...
              (y.prototype.sqrt = function(t) {
                ...
                for (
                  ...
                  i(d > g);
                  var v = this.pow(l, new o(1).iushln(d - g - 1));
                  (c = c.redMul(v)),
                    (l = v.redSqr()),
                    (p = p.redMul(l)),
                    (d = g);
              ...
              (y.prototype.pow = function(t, r) {
                ...
                for (var n = 2; i.length > n; n++) i[n] = this.mul(i[n - 1], t);
                var s = i[0],
                  h = 0,
                  u = 0,
                  a = r.bitLength() % 26;
      ...
      function(t, r, e) {
        ...
        t.exports = function(t) {
          if ('string' == typeof t || 'number' == typeof t) {
            ...
            if (
              ('-' === s.substr(0, 1) &&
                ((s = n(s.slice(1))), (r = new i(-1, 10))),
              (s = '' === s ? '0' : s),
              (!s.match(/^-?[0-9]+$/) && s.match(/^[0-9A-Fa-f]+$/)) ||
                s.match(/^[a-fA-F]+$/) ||
                (o === !0 && s.match(/^[0-9A-Fa-f]+$/)))
            )
              return new i(s, 16).mul(r);
            if ((s.match(/^-?[0-9]+$/) || '' === s) && o === !1)
      ...
      function(t, r, e) {
        ...
        (function(r) {
          ...
          function h(t, r, e) {
            ...
            return r[(!!e && 'some') || 'every'](function(r) {
              return t.indexOf(r) >= 0;
            });
          }
          function u(t) {
            var e = new r(i(m(t).replace(/^0+|0+$/g, '')), 'hex');
          ...
          function a(t) {
            var r = '',
              e = 0,
              i = t.length;
            for ('0x' === t.substring(0, 2) && (e = 2); i > e; e += 2) {
          ...
          function f(t) {
            var e = new r(t, 'utf8');
            return '0x' + i(e.toString('hex')).replace(/^0+|0+$/g, '');
          }
          function l(t) {
            for (var r = '', e = 0; t.length > e; e++) {
        ...
        (function(r, e) {
          ...
          !(function(i) {
            ...
            function n(t, r, e) {
              ...
              for (var i = 0; 50 > i; ++i) this.s[i] = 0;
            }
            var o = 'object' == typeof r && r.versions && r.versions.node;
            o && (i = e);
            for (
              var s = !i.JS_SHA3_TEST && 'object' == typeof t && t.exports,
                ...
                p = [224, 256, 384, 512],
                d = [128, 256],
                m = ['hex', 'buffer', 'arrayBuffer', 'array'],
                g = function(t, r, e) {
                  return function(i) {
                    return new n(t, r, t).update(i)[e]();
                  };
                },
                v = function(t, r, e) {
                  return function(i, o) {
                    return new n(t, r, o).update(i)[e]();
                  };
                },
                y = function(t, r) {
                  var e = g(t, r, 'hex');
                ...
                M = [
                  { name: 'keccak', padding: a, bits: p, createMethod: y },
                  { name: 'sha3', padding: f, bits: p, createMethod: y },
                  { name: 'shake', padding: u, bits: d, createMethod: w },
                ],
                b = {},
                _ = 0;
              M.length > _;
              ...
              for (var E = M[_], A = E.bits, x = 0; A.length > x; ++x)
                b[E.name + '_' + A[x]] = E.createMethod(A[x], E.padding);
            (n.prototype.update = function(t) {
              ...
              for (
                ...
                if (this.reset)
                  for (
                    this.reset = !1, s[0] = this.block, e = 1;
                    u + 1 > e;
                    ++e
                  )
                    s[e] = 0;
                if (r)
                  for (e = this.start; o > a && h > e; ++a)
                    s[e >> 2] |= t[a] << l[3 & e++];
                else
                  for (e = this.start; o > a && h > e; ++a)
                    (n = t.charCodeAt(a)),
                      128 > n
                        ...
                        : 2048 > n
                          ? ((s[e >> 2] |= (192 | (n >> 6)) << l[3 & e++]),
                            (s[e >> 2] |= (128 | (63 & n)) << l[3 & e++]))
                          : 55296 > n || n >= 57344
                            ? ((s[e >> 2] |= (224 | (n >> 12)) << l[3 & e++]),
                              (s[e >> 2] |=
                                (128 | ((n >> 6) & 63)) << l[3 & e++]),
                              (s[e >> 2] |= (128 | (63 & n)) << l[3 & e++]))
                            : ((n =
                                ...
                                (((1023 & n) << 10) |
                                  (1023 & t.charCodeAt(++a)))),
                              (s[e >> 2] |= (240 | (n >> 18)) << l[3 & e++]),
                              (s[e >> 2] |=
                                (128 | ((n >> 12) & 63)) << l[3 & e++]),
                              (s[e >> 2] |=
                                (128 | ((n >> 6) & 63)) << l[3 & e++]),
                              (s[e >> 2] |= (128 | (63 & n)) << l[3 & e++]));
                if (((this.lastByteIndex = e), h > e)) this.start = e;
                else {
                  for (this.start = e - h, this.block = s[u], e = 0; u > e; ++e)
                    f[e] ^= s[e];
                  S(f), (this.reset = !0);
                }
              }
              ...
              (n.prototype.finalize = function() {
                ...
                if (
                  ...
                  for (t[0] = t[e], r = 1; e + 1 > r; ++r) t[r] = 0;
                for (t[e - 1] |= 2147483648, r = 0; e > r; ++r) i[r] ^= t[r];
                S(i);
              }),
              (n.prototype.toString = n.prototype.hex = function() {
                ...
                return (
                  n &&
                    ((t = e[o]),
                    n > 0 && (u += h[(t >> 4) & 15] + h[15 & t]),
                    n > 1 && (u += h[(t >> 12) & 15] + h[(t >> 8) & 15]),
                    n > 2 && (u += h[(t >> 20) & 15] + h[(t >> 16) & 15])),
                  u
                );
              }),
              (n.prototype.arrayBuffer = function() {
                ...
                var t,
                  ...
                  s = 0,
                  h = this.outputBits >> 3;
                t = n ? new ArrayBuffer((i + 1) << 2) : new ArrayBuffer(h);
                for (var u = new Uint32Array(t); i > s; ) {
                  for (o = 0; r > o && i > s; ++o, ++s) u[s] = e[o];
                  s % r == 0 && S(e);
                }
                return n && ((u[o] = e[o]), (t = t.slice(0, h))), t;
              }),
            ...
            if (s) t.exports = b;
            else if (i) for (var B in b) i[B] = b[B];
          })(this);
        }.call(r, e(25), e(8)));
      },
      function(t, r, e) {
      ...
      function(t, r) {
          ...
          function e(t) {
            ...
            (e.filterId = null),
              ...
              (e.interval = setInterval(function() {
                null !== e.filterId &&
                  Object.keys(e.watchers).length > 0 &&
                  r.getFilterChanges(e.filterId, function(t, r) {
                    var i = [],
                      n = null;
                    if (!t)
                      try {
                        r.forEach(function(t, n) {
                          (i[n] = r[n]),
                            (i[n].data = e.options.decoder(i[n].data));
                        });
                      } catch (o) {
                        n = Error(
                    ...
                    Object.keys(e.watchers).forEach(function(o) {
                      var s = e.watchers[o];
                      return s.stop === !0
                        ? void delete e.watchers[o]
                        : void (n
                            ? (s.reject(n), s.callback(n, null))
                            : (t
                                ? s.reject(t)
                                : Array.isArray(i) &&
                                  r.length > 0 &&
          ...
          return (
            ...
            (e.prototype.uninstall = function(t) {
              var e = this,
                i = t || function() {};
              return (
                (e.watchers = Object.assign({})),
                clearInterval(e.interval),
                new Promise(function(t, n) {
                  r.uninstallFilter(e.filterId, function(r, e) {
                    r ? n(r) : t(e), i(r, e);
                  });
                })
              );
            ...
            (e.prototype['new'] = function() {
              ...
              return (
                'function' == typeof o[o.length - 1] && (e = o.pop()),
                'Filter' === t &&
                  n.push(
                    Object.assign(
                      i.options.defaultFilterObject,
                      o[o.length - 1] || {}
                    )
                  ),
                new Promise(function(o, s) {
                  n.push(function(t, r) {
                    t ? s(t) : ((i.filterId = r), o(r)), e(t, r);
                  }),
                    r['new' + t].apply(r, n);
                })
              );
        ...
        function i(t) {
          ...
          (r.Filter = e('Filter', t)),
            (r.BlockFilter = e('BlockFilter', t)),
            (r.PendingTransactionFilter = e('PendingTransactionFilter', t));
        }
        t.exports = i;
      },
      function(t, r) {
      ...
      function(t, r, e) {
        ...
        (function(r) {
          function i(t, r) {
            ...
            var e = this;
            e.options = r || {};
            var h = new n(t, e.options.query);
            Object.keys(Object.getPrototypeOf(h)).forEach(function(t) {
              e[t] = function() {
                for (var r = arguments.length, e = Array(r), i = 0; r > i; i++)
                  e[i] = arguments[i];
                return h[t].apply(h, e);
              };
            }),
              (e.filter = new o(h, e.options.query)),
              (e.contract = new s(h, e.options.query)),
              (e.currentProvider = h.rpc.currentProvider),
              (e.setProvider = h.setProvider),
              (e.getTransactionSuccess = d(e));
          }
          var n = e(19),
            o = e(6),
            s = e(14),
          ...
          (t.exports = i),
            (i.BN = c),
            (i.isAddress = function(t) {
              return p.isHexString(t, 20);
            }),
            (i.keccak256 = function(t) {
              return '0x' + f(t);
            }),
            (i.Buffer = r),
            (i.isHexString = p.isHexString),
            (i.fromWei = a.fromWei),
            (i.toWei = a.toWei),
            (i.toBN = l),
            (i.abi = u),
            (i.fromAscii = p.fromAscii),
            (i.toAscii = p.toAscii),
            (i.fromUtf8 = p.fromUtf8),
            (i.toUtf8 = p.toUtf8),
            (i.HttpProvider = h);
        }.call(r, e(0).Buffer));
      },
          ...
          return function(r, e) {
            ...
            return new Promise(function(e, s) {
              var u = setInterval(function() {
                if (
                  (t.getTransactionReceipt(r, function(t, r) {
                    t && (clearInterval(u), h(t, null), s(t)),
                      !t && r && (clearInterval(u), h(null, r), e(r));
                  }),
                  i >= n)
                ) {
                  clearInterval(u);
                  var a = 'Receipt timeout waiting for tx hash: ' + r;
                  h(a, null), s(a);
                }
                i += o;
              }, o);
      ...
      function(t, r) {
        ...
        function n(t) {
          var r,
            ...
            h,
            u = t.length;
          (s = e(t)), (h = new f(3 * u / 4 - s)), (n = s > 0 ? u - 4 : u);
          var l = 0;
          for (r = 0, i = 0; n > r; r += 4, i += 3)
            (o =
              (a[t.charCodeAt(r)] << 18) |
          ...
          return (
            2 === s
              ? ((o =
                  (a[t.charCodeAt(r)] << 2) | (a[t.charCodeAt(r + 1)] >> 4)),
                (h[l++] = 255 & o))
              : 1 === s &&
                ((o =
                  (a[t.charCodeAt(r)] << 10) |
        ...
        function s(t, r, e) {
          for (var i, n = [], s = r; e > s; s += 3)
            (i = (t[s] << 16) + (t[s + 1] << 8) + t[s + 2]), n.push(o(i));
          return n.join('');
        }
        function h(t) {
          for (
        ...
        (r.byteLength = i), (r.toByteArray = n), (r.fromByteArray = h);
        for (
          var u = [],
            a = [],
      ...
      function(t, r, e) {
        ...
        (function(r) {
          function i(t) {
            for (var r = t, e = r[0]; r.length > 0 && '' + e == '0'; )
              (r = r.slice(1)), (e = r[0]);
            return r;
          }
          function n(t) {
            var e = t,
              n = e.toString(16);
            return n.length % 2 && (n = '0' + n), i(new r(n, 'hex'));
          }
          function o(t, r) {
            return (
              !('string' != typeof t || !t.match(/^0x[0-9A-Fa-f]*$/)) &&
            ...
            return {
              encode: function(i) {
                ...
                return (
                  'object' == typeof n &&
                    n.toString &&
                    (n.toTwos || n.dividedToIntegerBy) &&
                    (n = n.toString(10).split('.')[0]),
                  ('string' != typeof n && 'number' != typeof n) ||
                    (n = (n + '').split('.')[0]),
                  (n = g(n)),
                  (n = n.toTwos(8 * t).maskn(8 * t)),
                  e && (n = n.fromTwos(8 * t).toTwos(256)),
                  n.toArrayLike(r, 'be', 32)
                );
              },
              decode: function(r, i) {
                var n = 32 - t,
                  o = new m(r.slice(i + n, i + 32));
                return (
                  (o = e ? o.fromTwos(8 * t) : o.maskn(8 * t)),
                  { consumed: 32, value: new m(o.toString(10)) }
                );
              },
            };
          }
          function f(t) {
            return {
              encode: function(t) {
                var e = t;
                if (((e = s(e)), 32 === e.length)) return e;
                var i = new r(32);
                return i.fill(0), e.copy(i), i;
              },
              decode: function(r, e) {
                if (0 !== r.length && e + 32 > r.length)
                  throw Error(
          ...
          function l(t) {
            var e = parseInt(32 * Math.ceil(t.length / 32)),
              i = new r(e - t.length);
            return i.fill(0), r.concat([y.encode(t.length), t, i]);
          }
          function c(t, r) {
            if (0 !== t.length && r + 32 > t.length)
              throw Error(
            ...
            var e = y.decode(t, r).value;
            if (((e = e.toNumber()), 0 !== t.length && r + 32 + e > t.length))
              throw Error(
                '[ethjs-abi] while decoding dynamic bytes data, invalid bytes length: ' +
                  t.length +
                  ' should be less than ' +
          ...
          function p(t, e) {
            return {
              ...
              decode: function(r, i) {
                ...
                for (var u = [], a = 0; o > a; a++) {
                  var f = t.decode(r, s);
                  (h += f.consumed), (s += f.consumed), u.push(f.value);
                }
                return { consumed: h, value: u };
              },
              dynamic: e === -1,
            };
          }
          ...
          var m = e(1),
            ...
            M = {
              encode: function(t) {
                ...
                return (e = s(e)), i.fill(0), e.copy(i, 12), i;
              },
              decode: function(t, r) {
      ...
      function(t, r, e) {
        'use strict';
        function i(t) {
          var r = ['from', 'to', 'data', 'value', 'gasPrice', 'gas'];
          return !(
            'object' != typeof t ||
            Array.isArray(t) !== !0 ||
            0 >= t.length ||
            'object' != typeof t[t.length - 1] ||
            (0 !== Object.keys(t[t.length - 1]).length &&
              !c(Object.keys(t[t.length - 1]), r, !0))
          );
        }
        function n(t) {
        ...
        function o(t) {
          return t.filter(function(t) {
            return (
              ('function' === t.type || 'event' === t.type) && t.name.length > 0
            );
          });
        }
        function s(t) {
          return function(r, e, s) {
            ...
            return (
                      ...
                      h[r.name] = function() {
                        ...
                        if (
                          ...
                          return new Promise(function(a, f) {
                            ...
                            i(s) && (n = s.pop());
                            var c = Object.assign({}, h.defaultTxObject, n, {
                              to: h.address,
                            });
                            (c.data = u.encodeMethod(r, s)),
                              r.constant === !1 && (e = 'sendTransaction'),
                              t[e](c, l);
                          });
                        if ('event' === r.type) {
                          var f = (function() {
                            var t = l(r.inputs, 'type', !1),
                              e = '0x' + a(r.name + '(' + t.join(',') + ')'),
                              i = [e],
                              n = Object.assign({}, s[0]) || {};
                            return {
                              v: new h.filters.Filter(
                                Object.assign({}, n, {
                                  decoder: function(t) {
                                    return u.decodeEvent(r, t, i);
                                  },
                                  defaultFilterObject: Object.assign(
                                    {},
                                    s[0] || {},
                                    { to: h.address, topics: i }
                                  ),
                                })
                              ),
                            };
              ...
              (h['new'] = function() {
                ...
                'function' == typeof a[a.length - 1] && (h = a.pop()),
                  i(a) && (o = a.pop());
                var f = n(r),
                  c = Object.assign({}, s, o);
                if ((e && (c.data = e), f)) {
                  var p = u.encodeParams(l(f.inputs, 'type'), a).substring(2);
                  c.data = '' + c.data + p;
                }
                return t.sendTransaction(c, h);
              }),
              h
            );
          };
      ...
      function(t, r, e) {
        ...
        function i(t, r) {
          if (
            ['string', 'number', 'object'].indexOf(typeof t) === -1 ||
            null === t
          )
            return t;
          var e = p(t);
          ...
          return r ? '0x' + e.toString(16) : e;
        }
        function n(t, r) {
          var e = t;
          return l.tags.indexOf(t) === -1 && (e = i(t, r)), e;
        }
        function o(t, r) {
          var e = t,
            i = 0;
          if (
            ('string' == typeof t && ((e = '0x' + m(d(t))), (i = v(e))),
            '0x00' === e && (e = '0x0'),
            'number' == typeof r &&
              null !== t &&
              '0x' !== e &&
              '0x0' !== e &&
              (!/^[0-9A-Fa-f]+$/.test(d(e)) || i !== 2 + 2 * r))
          )
            throw Error(
        ...
        function s(t, r, e) {
          ...
          if (
            ('string' == typeof t &&
              (n =
                'Boolean|EthSyncing' === t
                  ? Object.assign({}, l.objects.EthSyncing)
                  : 'DATA|Transaction' === t
                    ? Object.assign({}, l.objects.Transaction)
                    : Object.assign({}, l.objects[t])),
            !g(Object.keys(r), n.__required))
          )
            throw Error(
              '[ethjs-format] object ' +
                JSON.stringify(r) +
        ...
        function h(t, r, e, i) {
          ...
          if (
            ('Array|DATA' === t && (o = ['D']),
            'FilterChange' === t && 'string' == typeof r[0] && (o = ['D32']),
            e === !0 && 'number' == typeof i && i > r.length)
          )
            throw Error(
              'array ' +
                JSON.stringify(r) +
                  ...
                  : 'D20' === t
                    ...
                    : 'D32' === t
                      ...
                      : 'object' == typeof r &&
                        ...
                        Array.isArray(r) === !1
                        ? (a = s(t, r, e))
                        : Array.isArray(r) && (a = h(t, r, e, u)),
            a
          );
        }
        function a(t, r) {
          return u(l.methods[t][0], r, !0, l.methods[t][2]);
        }
        function f(t, r) {
          return u(l.methods[t][1], r, !1);
        }
        var l = e(24),
          c = e(3),
          p = e(2),
          d = e(5),
          m = c.padToEven,
          g = c.arrayContainsArray,
          v = c.getBinarySize;
        t.exports = {
          schema: l,
          formatQuantity: i,
          formatQuantityOrTag: n,
          formatObject: s,
          formatArray: h,
          format: u,
          formatInputs: a,
      ...
      function(t, r, e) {
        ...
        function i(t, r) {
          var e = Error(
            '[ethjs-provider-http] Invalid JSON RPC response from provider\n    host: ' +
              r +
              '\n    response: ' +
              (t.responseText + '') +
              ' ' +
              JSON.stringify(t.responseText, null, 2) +
              '\n    responseURL: ' +
              t.responseURL +
              '\n    status: ' +
              t.status +
      ...
      function(t, r, e) {
        ...
        function i(t, r) {
          ...
          (e.options = Object.assign({
            ...
            (e.rpc = new s(t)),
            (e.setProvider = e.rpc.setProvider);
        }
        function n(t, r) {
          return function() {
            var e = function() {},
            ...
            return (
              ...
              new Promise(function(u, a) {
                    ...
                    try {
                      n.log(
                        "attempting method formatting for '" +
                          h +
                          "' with raw outputs: " +
                          JSON.stringify(i, null, n.options.jsonSpace)
                      );
                      var s = o.formatOutputs(t, i);
                      n.log(
                        "method formatting success for '" +
                          h +
                          "' formatted result: " +
                          JSON.stringify(s, null, n.options.jsonSpace)
                      ),
                        u(s),
                        e(null, s);
                    } catch (f) {
                ...
                r[3] && r[3] > s.length && s.push('latest'),
                  n.log(
                    "attempting method formatting for '" +
                      h +
                      "' with inputs " +
                ...
                return n.rpc.sendAsync({ method: t, params: i }, f);
              })
            );
          };
        }
        ...
        (t.exports = i),
          (i.prototype.log = function(t) {
            var r = this;
            r.options.debug && r.options.logger.log('[ethjs-query log] ' + t);
          }),
          Object.keys(o.schema.methods).forEach(function(t) {
            Object.defineProperty(i.prototype, t.replace('eth_', ''), {
              enumerable: !0,
              value: n(t, o.schema.methods[t]),
            });
          });
      },
      function(t, r) {
        ...
        function e(t, r) {
          ...
          (i.options = Object.assign({
            ...
            (i.idCounter = Math.floor(Math.random() * i.options.max)),
        ...
        function i(t, r) {
          return Object.assign({}, { id: r, jsonrpc: '2.0', params: [] }, t);
        }
        (t.exports = e),
          (e.prototype.sendAsync = function(t, r) {
            var e = this;
            e.idCounter = e.idCounter % e.options.max;
            var n = i(t, e.idCounter++);
            e.currentProvider.sendAsync(n, function(t, i) {
              var o = i || {};
              if (t || o.error) {
                var s =
                    '[ethjs-rpc] ' +
                    ((o.error && 'rpc') || '') +
                    ' error with payload ' +
                    JSON.stringify(n, null, e.options.jsonSpace) +
                    ' ' +
                    (t + '' ||
                      JSON.stringify(o.error, null, e.options.jsonSpace)),
                  h = Error(s);
                return (h.value = t || o.error), r(h, null);
              }
              return r(null, o.result);
            });
          });
      },
      function(t, r, e) {
        ...
        function n(t) {
          ...
          if (
            ...
            return t.toPrecision ? t.toPrecision() + '' : t.toString(10);
          throw Error(
            "while converting number to string, invalid number value '" +
              t +
              "' type " +
        ...
        function o(t, r, e) {
          var n = u(t),
            ...
            c = e || {};
          o && (n = n.mul(f));
          for (var p = n.mod(s).toString(10); h > p.length; ) p = '0' + p;
          c.pad || (p = p.match(/^([0-9]*[1-9]|0)(0*)/)[1]);
          var d = n.div(s).toString(10);
        ...
        function s(t, r) {
          ...
          (c = new h(c)), (p = new h(p));
          var d = c.mul(o).add(p);
          return u && (d = d.mul(f)), new h(d.toString(10), 10);
        }
        var h = e(1),
          u = e(2),
          a = new h(0),
              ...
              r = Math.abs(r),
                isNaN(r) || r === 1 / 0
                  ...
                  : ((s = Math.floor(Math.log(r) / Math.LN2)),
                    ...
                    (r += 1 > s + l ? c * Math.pow(2, 1 - l) : c / u),
                    2 > r * u || (s++, (u /= 2)),
                    f > s + l
                      ? 1 > s + l
                        ? ((h = r * Math.pow(2, l - 1) * Math.pow(2, n)),
                          (s = 0))
                        : ((h = (r * u - 1) * Math.pow(2, n)), (s += l))
                      : ((h = 0), (s = f)));
              n >= 8;
              t[e + p] = 255 & h, p += d, h /= 256, n -= 8
            );
            for (
              s = (s << n) | h, a += n;
              a > 0;
              t[e + p] = 255 & s, p += d, s /= 256, a -= 8
            );
            t[e + p - d] |= 128 * m;
          });
      },
      ...
      function(t, r) {
        t.exports = {
          ...
          objects: {
            ...
            SHHFilter: { __required: ['topics'], to: 'D', topics: ['D'] },
            SHHFilterChange: {
              __required: [],
              hash: 'D',
              from: 'D',
      ...
      function(t, r) {
        ...
        (c.nextTick = function(t) {
          ...
          if (arguments.length > 1)
            for (var e = 1; arguments.length > e; e++) r[e - 1] = arguments[e];
          d.push(new u(t, r)), 1 !== d.length || m || n(h);
        }),
        ...
        (function(r) {
          ...
          function o(t, e) {
            ...
            t.forEach(function(t, r) {
              var i = g(t);
              n.push({ dynamic: i.dynamic, value: i.encode(e[r]) });
            });
            var o = 0,
              s = 0;
            n.forEach(function(t) {
              t.dynamic
                ? ((o += 32), (s += i(t.value.length)))
                : (o += i(t.value.length));
            });
            var h = 0,
              u = o,
              ...
              n.forEach(function(t, r) {
                t.dynamic
                  ? (m.encode(u).copy(a, h),
                    ...
                    t.value.copy(a, u),
                    (u += i(t.value.length)))
                  : (t.value.copy(a, h), (h += i(t.value.length)));
              }),
              '0x' + a.toString('hex')
            );
          }
          function s(t, r, e) {
            ...
            return (
              r.forEach(function(r, n) {
                ...
                if (h.dynamic) {
                  var u = m.decode(e, s),
                    a = h.decode(e, u.value.toNumber());
                  s += u.consumed;
                } else {
                  var a = h.decode(e, s);
                  s += a.consumed;
                }
                i && (o[n] = a.value), t[n] && (o[t[n]] = a.value);
              }),
              o
            );
          }
          function h(t, e) {
            var i = t.name + '(' + d.getKeys(t.inputs, 'type').join(',') + ')',
              n =
                '0x' + new r(d.keccak256(i), 'hex').slice(0, 4).toString('hex'),
              s = o(d.getKeys(t.inputs, 'type'), e).substring(2);
            return '' + n + s;
          }
          function u(t, r) {
            var e = d.getKeys(t.outputs, 'name', !0),
              i = d.getKeys(t.outputs, 'type');
            return s(e, i, d.hexOrBuffer(r));
          }
          function a(t, r) {
            return h(t, r);
          }
          function f(t) {
            var r = t.name + '(' + d.getKeys(t.inputs, 'type').join(',') + ')';
            return '0x' + d.keccak256(r);
          }
          function l(t, e, i) {
            var n =
                3 >= arguments.length ||
                void 0 === arguments[3] ||
                arguments[3],
              o = t.inputs.filter(function(t) {
                return !t.indexed;
              }),
              h = d.getKeys(o, 'name', !0),
              u = d.getKeys(o, 'type'),
              a = s(h, u, d.hexOrBuffer(e), n),
              f = t.anonymous ? 0 : 1;
            return (
              t.inputs
                .filter(function(t) {
                ...
                .map(function(t, e) {
                  var n = new r(i[e + f].slice(2), 'hex'),
                    o = g(t.type);
                  a[t.name] = o.decode(n, 0).value;
                }),
              (a._eventName = t.name),
              a
            );
