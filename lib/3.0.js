!function(e) {
    ...
    }(), g = r(3), v = r(38), b = r(50), w = o(b), _ = r(58), x = r(46), A = r(187), E = n(A), P = r(186), O = r(61), T = r(47), R = r(54), C = r(75);
        ...
        m(t, [{
            ...
            value: function() {
                ...
                var t = function(t) {
                  ...
                  , r = this.state
                  , n = this.$storage;
                this.getLimits().then(function() {
                    var o = n.getItem("loanApplyInfo")
                      , i = r.selectTag;
                    if (o && o.maturityType) {
                        i = o.maturityType;
                        var a = r[i + "Limit"];
                        e.$update([{
                            ...
                            name: "selectAmount" + i,
                            index: Object.keys(a).findIndex(function(e) {
                                return e === o.amount
                            })
                        }, {
                            name: "selectMaturity" + i,
                            index: a[o.amount].findIndex(function(e) {
                                return e === o.maturity
                            })
                        }])
                    }
            ...
            value: function() {
                ...
                this.$update([{
                    name: "totalAmount" + n,
                    text: i ? (0,
                    T.toThousands)(o ? t.discountPerItemAmount : t.perItemAmount) : (0,
                    T.toThousands)(a)
                }, {
                    name: "monthPaymentText",
                    text: (0,
                    T.toThousands)(o ? t.discountPerItemAmount : t.perItemAmount)
                }]),
            ...
            value: function() {
                ...
                n = n.concat([{
                    ...
                    name: "costDetailTile",
                    text: (0,
                    T.toThousands)(t.amount) + "元/" + t.maturity + ("monthly" === e ? "月" : "天")
                }]),
                this.$update(n)
            }
        }, {
...
, function(e, t, r) {
    ...
    var o = r(16)
      ...
      , u = r(2)
      , c = r(15);
    "undefined" == typeof window.Promise && (r(43).enable(),
    window.Promise = r(42));
    ...
    f.interceptors.response.use(function(e) {
        ...
        try {
            ...
            return window.Promise.reject(t)
        }
        var n = r.result;
        ...
        window.Promise.reject(r)) : window.Promise.reject(r)
    }),
    t.default = f
}
, function(e, t, r) {
...
, , function(e, t, r) {
    ...
    t.$share = t.$goto = t.$load = t.$update = t.$command = void 0;
    var n = r(3)
...
, function(e, t, r) {
    ...
    var n = r(13)
      ...
      , u = function e(t, r, o, i, a, s, u, c, f, l, h, p) {
        ...
        for (var b = 0; b < g.length; ++b) {
            var w = g[b];
            a && null  === d[w] || (m = Array.isArray(d) ? m.concat(e(d[w], o(r, w), o, i, a, s, u, c, f, l, h, p)) : m.concat(e(d[w], r + (f ? "." + w : "[" + w + "]"), o, i, a, s, u, c, f, l, h, p)))
        }
        return m
    }
    ;
    e.exports = function(e, t) {
        ...
        var g, v, b = o.formatters[n.format];
        ...
        for (var A = 0; A < g.length; ++A) {
            var E = g[A];
            f && null  === r[E] || (w = w.concat(u(r[E], E, x, c, f, l ? h : null , v, p, d, y, b, m)))
        }
        return w.join(a)
    }
}
...
, function(e, t, r) {
    ...
    t.getAds = t.getActivities = void 0;
    var o = r(5)
      , i = n(o);
    ...
    ,
    t.getAds = function() {
        return i.default.get("/api/v2/cashloan/activity/banners")
    }
}
, function(e, t, r) {
    "use strict";
    ...
    u = function() {
        function e() {
            ...
            this.state = {},
            this.computed = {},
            this._watcher = new b.default(this.state)
        }
        return c(e, [{
            key: "eventHandler",
            value: function(e) {
            ...
            value: function(e) {
                var t = e.clickIndex;
                this.$share(this.state.bannerList[t].toUrl)
            }
        }, {
            key: "$renderAds",
            value: function() {
                var e = this
                  , t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "ads"
                  , r = function(r) {
                    return Promise.resolve(e.$update({
                        name: t,
                        datas: r.map(function(e) {
                            return e.bannerPic
                        })
                    }))
                }
                  , n = this.state.bannerList;
                return n && n.length ? r(this.state.bannerList) : (0,
                _.getAds)().then(function(t) {
                    var n = t.content.bannerList;
                    if (n.length)
                        return e.state.bannerList = n,
                        r(n)
                })
            }
        }]),
    ...
    u);
    t.default = x,
    Object.assign(x.prototype, h, d),
    x.prototype.$storage = g.$storage,
    x.prototype.PATH = w.PATH,
    x.prototype.$formatter = m
}
, function(e, t) {
    "use strict";
...
, function(e, t) {
    ...
    Promise.prototype.done = function(e, t) {
        this.then(e, t).catch(console.error)
    }
    ,
...
, function(e, t) {
    ...
    ,
    t.setUserInfo = function() {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
        if (localStorage.phone && "object" === ("undefined" == typeof e ? "undefined" : r(e))) {
            var t = localStorage[localStorage.phone] || {};
            Object.assign(t, e),
            localStorage[localStorage.phone] = JSON.stringify(t)
        }
    }
}
, , , , , function(e, t) {
...
, function(e, t, r) {
    ...
    function o() {
        try {
            var e = "https://" + (c.search(/dev|hero-mobile|demo|-liu|local|10/i) > 0 ? "www-demo.dianrong.com" : "dianrong.com");
            u.default.get(e + "/feapi/items", {
                params: {
                    type: "cashloan-notifications"
                }
            }).then(function(e) {
                if ("success" === e.result && e.content && e.content.list && e.content.list.length) {
                    var t = e.content.list[0];
    ...
    t.getContentFromCms = void 0;
    var a = r(3)
      , s = r(5)
      , u = n(s)
      , c = window.location.origin;
    t.getContentFromCms = o
}
, , , , , , , , , , , , function(e, t, r) {
    "use strict";
    function n(e) {
